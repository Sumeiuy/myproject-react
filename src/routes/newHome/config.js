...
const stepIds = {
  ...
  tabMenu: { id: '第二个', name: '主导航',step:1},
  homePageIntroThirdStep: { id: '第三个', name:'重点关注客户',step:2},
  homePageIntroFourthStep: { id: '第四个', name:'猜你感兴趣' ,step:3},
  homePageIntroFifthStep: { id: '第五个', name:'客户分析' ,step:4},
  homePageIntroSixthStep: { id: '第六个', name: '产品日历',step:5},
  homePageIntroSeventhStep: { id: '第七个', name: '组合推荐',step:6},
  homePageIntroEighthStep: { id: '第八个', name: '活动栏目',step:7},
