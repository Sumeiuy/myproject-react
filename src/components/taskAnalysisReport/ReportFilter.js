 ...
 * @Last Modified time: 2018-11-02 09:27:48
 */
...
import {
  defaultStartTime, defaultEndTime, executeTypeOptions, eventSourceOptions
} from './config';
...
export default class ReportFilter extends PureComponent {
  ...
  render() {
    ...
    // 事件类型中字典里面没有不限，新增不限
    const newEventTypeOptions = [{ key: '', value: '不限' }, ...eventTypeOptions];
