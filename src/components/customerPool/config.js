...
filterField: 'mobile' },
  { labelName: '经济客户号',
filterField: 'sorPtyId' },
  { labelName: '股东账号',
filterField: 'primaryKey' },
];
...
export const commonFilterList = [
  { labelName: '已开通业务',
filterField: 'rights',
dictField: 'custBusinessType' },
  { labelName: '可开通业务',
filterField: 'unrights',
dictField: 'custUnrightBusinessType' },
  { labelName: '客户性质',
filterField: 'customType',
dictField: 'custNature' },
  { labelName: '客户类型',
filterField: 'custClass',
dictField: 'custType' },
  { labelName: '风险等级',
filterField: 'riskLevels',
dictField: 'custRiskBearing' },
  { labelName: '客户等级',
filterField: 'customerLevel',
dictField: 'custLevelList' },
  { labelName: '未完备信息',
filterField: 'completedRate',
dictField: 'completenessRateList' },
  { labelName: '投资期限',
filterField: 'investPeriod',
dictField: 'investPeriodDictionary' },
  { labelName: '投资偏好',
filterField: 'investVariety',
dictField: 'investVarietyDictionary' },
  { labelName: '账户状态',
filterField: 'accountStatus',
dictField: 'accountStatusList' },
  { labelName: '持仓行业',
filterField: 'primaryKeyIndustry',
dictField: 'industryList' },
];

// 带搜索的筛选组件集合
export const singleWithSearchFilterList = [
  { labelName: '介绍人',
filterField: 'devMngId' },
  { labelName: '订购组合',
filterField: 'primaryKeyJxgrps' },
];
...
export const dateRangeFilterList = [
  { labelName: '高端产品户认定日期',
filterField: 'highPrdtDt' },
  { labelName: '产品户认定日期',
filterField: 'buyProdDt' },
  { labelName: '签约日期',
filterField: 'tgSignDate' },
  { labelName: '高净值户认定日期',
filterField: 'gjzDt' },
  { labelName: '有效户生效日期',
filterField: 'validDt' },
...
export const buyAmtFilterList = [
  { labelName: '公募基金购买金额',
filterField: 'kfBuyAmt' },
  { labelName: '私募基金购买金额',
filterField: 'smBuyAmt' },
  { labelName: '紫金产品购买金额',
filterField: 'finaBuyAmt' },
  { labelName: 'OTC购买金额',
filterField: 'otcBuyAmt' },
  { labelName: '基础股基交易量',
filterField: 'gjAmt' },
  { labelName: '股基净佣金',
filterField: 'gjPurRake' },
  { labelName: '净利息额',
filterField: 'netIncome' },
  { labelName: '净佣金额',
filterField: 'purRake' },
  { labelName: '产品净手续费',
filterField: 'saleFare' },
  { labelName: '净转入资产',
filterField: 'purFinAset' },
  { labelName: '收益',
filterField: 'pftAmt' },
  { labelName: '收益率',
filterField: 'maxCostRate',
unit: '%' },
];
...
filterField: 'avlAmt' },
  { labelName: '信用可用资金',
filterField: 'avlAmtCrdt' },
  { labelName: '总市值（含信用）',
filterField: 'totMktVal' },
  { labelName: '归集率',
filterField: 'gjlRate' },
  { labelName: '外部市值',
filterField: 'outMktVal' },
  { labelName: '天天发市值',
filterField: 'ttfMktVal' },
];
